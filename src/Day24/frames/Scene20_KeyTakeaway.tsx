...
export const Scene20_KeyTakeaway: React.FC = () => {
  ...
  const lineAnim = [interpolate(frame, [4, 14], [0, 1], { extrapolateRight: "clamp", easing: ease }), interpolate(frame, [12, 22], [0, 1], { extrapolateRight: "clamp", easing: ease }), interpolate(frame, [20, 30], [0, 1], { extrapolateRight: "clamp", easing: ease }), interpolate(frame, [28, 38], [0, 1], { extrapolateRight: "clamp", easing: ease })];
    ...
    <AbsoluteFill>
      ...
      <svg width={1080} height={1920} style={{ position: 'absolute', inset: 0 }}>
        ...
        <text x={540} y={220} textAnchor="middle"
          ...
          fill={COLORS.warm_blue} letterSpacing="0.25em"
        ...
        {/* ── Takeaway lines ── */}
          ...
          <text x={540} y={740} textAnchor="middle"
            fontFamily="'Inter', sans-serif" fontSize={60} fontWeight={700}
            fill={COLORS.deep_black} opacity={lineAnim[3]}>
            That is an agent.
          </text>

        {/* ── Bottom accent bar ── */}
        <rect x={160} y={1700} width={760} height={6} rx={3}
          fill={COLORS.warm_blue} opacity={dotEnter * 0.25} />
      </svg>

      <CaptionBar
        text="Key takeaway: the loop is everything."
...
export default Scene20_KeyTakeaway;
