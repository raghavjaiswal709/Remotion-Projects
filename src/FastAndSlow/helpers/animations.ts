/**
 * Fast & Slow Pointers — Animation Utilities
 *
 * Same engine as TwoPointers, tuned for 60fps.
 */
...
// ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
// NODE CONSTANTS (linked list style)
// ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
export const NODE = {
    ...
    R: 45,       // circle
    BORDER: 3,
    get STEP() { return this.W + this.GAP; },
} as const;
...
export const tickValue = (frame: number, delay: number, from: number, to: number, dur = 40): number => {
    const raw = interpolate(frame, [delay, delay + dur], [0, 1], { extrapolateLeft: 'clamp', extrapolateRight: 'clamp' });
    return from + (to - from) * easeOutCubic(raw);
};
