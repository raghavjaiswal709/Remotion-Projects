...
export const Scene17_KeyTakeaway: React.FC = () => {
  ...
  return (
    <AbsoluteFill>
      ...
      <CaptionBar
        text="Observations are the world's reply. No observations? The loop goes dark."
        opacity={interpolate(frame, [4, 12], [0, 1], { extrapolateRight: 'clamp' })}
        highlightWords={['Observations', 'dark']}
      />
    </AbsoluteFill>
  );
};

export default Scene17_KeyTakeaway;
