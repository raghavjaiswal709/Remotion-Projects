    ...
    <AbsoluteFill>
      ...
      <svg style={{ position: 'absolute', inset: 0 }} width={1080} height={1920}>
        ...
        <line x1={0} y1={700} x2={1080} y2={700}
          stroke={COLORS.warm_blue} strokeWidth={1} opacity={enter * 0.12} />
        <line x1={0} y1={1140} x2={1080} y2={1140}
          stroke={COLORS.warm_blue} strokeWidth={1} opacity={enter * 0.12} />

        {/* ── Corner accents ── */}
        <path d="M 60,60 L 60,160 M 60,60 L 160,60"
          fill="none" stroke={COLORS.warm_blue} strokeWidth={3} strokeLinecap="round"
          opacity={enter * 0.45} />
        ...
        <text x={540} y={680} textAnchor="middle"
          ...
          fill={COLORS.warm_blue} letterSpacing="0.22em"
          opacity={enter * 0.6}>
        ...
        <text x={540} y={1080} textAnchor="middle"
          ...
          fill={COLORS.warm_blue} letterSpacing="-0.05em"
          opacity={enter * 0.12}>
          26
        </text>
        <text x={540} y={1080} textAnchor="middle"
        ...
        <text x={540} y={1230} textAnchor="middle"
          ...
          fill={COLORS.warm_blue} letterSpacing="0.1em"
          opacity={subEnter}>
          OBSERVATIONS
        </text>
        ...
        <text x={540} y={1300} textAnchor="middle"
          ...
          The world's reply to the agent
        </text>
