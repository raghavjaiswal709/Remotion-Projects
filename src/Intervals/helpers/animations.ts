/**
 * Intervals Pattern — Animation Utilities
 *
 * Same engine as FastAndSlow/TwoPointers, tuned for 60fps.
 * Added: interval bar rendering helpers, merge animations.
 */
...
export const BAR = {
    ...
    RADIUS: 10,
    BORDER: 3,
    /** Pixels per unit on the timeline axis */
    UNIT_PX: 60,
    /** X offset for the axis origin */
    AXIS_X: 80,
    /** Y start for first bar */
    BASE_Y: 120,
} as const;
...
export const strokeAnim = (frame: number, delay: number, totalLength: number, dur = 40): { strokeDasharray: string; strokeDashoffset: number } => {
    const progress = interpolate(frame, [delay, delay + dur], [0, 1], { extrapolateLeft: 'clamp', extrapolateRight: 'clamp' });
    return { strokeDasharray: `${totalLength}`, strokeDashoffset: totalLength * (1 - easeOutCubic(progress)) };
};
...
// ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
// INTERVAL BAR HELPERS
// ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

/** Convert interval value to pixel position on timeline */
export const valToX = (val: number): number => BAR.AXIS_X + val * BAR.UNIT_PX;

/** Get bar width from interval */
export const barWidth = (interval: [number, number]): number =>
    (interval[1] - interval[0]) * BAR.UNIT_PX;

/** Get Y position for bar at index */
export const barY = (index: number): number =>
    BAR.BASE_Y + index * (BAR.HEIGHT + BAR.GAP);
